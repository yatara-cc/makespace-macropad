/*
  # Pines firmware para ATMEGA32U4.

  Imprime constantemente un reporte del estado de los interruptores
  por communicación serial para enseñar el comportamiento de los
  pines según su configuración y el estado de los interruptores.
...
void init_pines(void) {
  ...
  pinMode(pin_e[0], OUTPUT);
  pinMode(pin_e[1], OUTPUT);
  digitalWrite(pin_e[0], LOW);
  digitalWrite(pin_e[1], HIGH);

  pinMode(pin_l[0], INPUT);
  
  pinMode(pin_l[1], INPUT_PULLUP);
}
